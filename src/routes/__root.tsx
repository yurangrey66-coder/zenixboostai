...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Zenix Boost — Anúncios inteligentes em Moçambique" },
      { property: "og:description", content: "Plataforma de anúncios com IA, planos diários, semanais e mensais." },
